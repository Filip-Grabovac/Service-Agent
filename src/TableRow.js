    ...
    getActionRow (menu, tab, item) {
        const actionRows = {
            ...
            5: {
                1:`
                    <div class="row-inside right">
                        <div data-modal-open="edit-document-address-popup" data-id-documents-address-id="${item._document_addresses_of_documents.id}" data-fill-5-1=${item._document_addresses_of_documents.id} style="display: none"></div>
