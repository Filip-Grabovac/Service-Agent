        ...
        const actionRows = {
            ...
            7: {
                1:`
                    <div class="row-inside right">
                        ${item.is_active === false ? `
                            <div data-payment-open="aircraft" data-id-certificates-id="${item.id}" class="actions-svg-wrap pay-btn-cert">Complete Payment Now</div>
                        ` : ''}
                ...
                2:`
                    <div class="row-inside right">
                        ${item.is_active === false ? `
                            <div data-payment-open="airman" data-id-certificates-id="${item.id}" class="actions-svg-wrap pay-btn-cert">Complete Payment Now</div>
                        ` : ''}
